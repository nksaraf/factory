  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <EmptyState
        ...
        description="This will include severity tracking, incident timelines, responder assignment, affected services mapping, and postmortem linking. The Incident entity is being added to the ops schema."
      />
    </div>
  )
}
