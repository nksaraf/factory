...
import {
  ...
  TabsList,
  TabsTrigger,
} from "@rio.js/ui-next/components/tabs"
```
  ...
  <div>
    ...
    <Tabs defaultValue="a" variant="default">
      <TabsList variant="default">
        <TabsTrigger value="a" variant="default">
          Overview
        </TabsTrigger>
  ...
  <div>
    ...
    <Tabs defaultValue="a" variant="outline">
      <TabsList variant="outline">
        <TabsTrigger value="a" variant="outline">
          Overview
        </TabsTrigger>
        <TabsTrigger value="b" variant="outline">
          Details
        </TabsTrigger>
      </TabsList>
    </Tabs>
...
import {
  ...
  BreadcrumbPage,
  BreadcrumbSeparator,
} from "@rio.js/ui-next/components/breadcrumb"
```
...
import {
  ...
  DropdownMenuTrigger,
} from "@rio.js/ui-next/components/dropdown-menu"
```
