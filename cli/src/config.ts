...
export const DX_CONFIG_FIELDS = {
  ...
  workbenchReposDir: { type: "string", default: "" },
  /** Base directory for worktree workbenches (e.g., ~/conductor/workbenches). Auto-detected from Conductor layout if empty. */
  workbenchWorktreesDir: { type: "string", default: "" },
} as const
