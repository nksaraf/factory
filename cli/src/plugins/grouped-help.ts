...
const CATEGORIES: [category: string, commands: string[]][] = [
  ["Setup", ["install", "auth", "self-update", "whoami"]],
  ["Project Lifecycle", ["init", "upgrade", "sync", "doctor"]],
  ["Development", ["dev", "up", "down", "status", "logs"]],
  ["Quality", ["check", "lint", "typecheck", "test", "format", "generate"]],
  ["Database", ["db"]],
  ["Deploy", ["env", "deploy", "release", "secret", "preview"]],
  [
    "Infrastructure",
    ["tunnel", "connect", "infra", "cluster", "kube", "workbench", "site"],
  ],
  [
    "Platform",
    [
