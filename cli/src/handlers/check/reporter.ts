...
import type { CheckReport, CheckResult, ComponentReport } from "../../lib/quality/types.js";
...
export function printSummary(
  ...
  for (const comp of report.components) {
    const compQuality = resolveComponentQuality(report.quality, comp.component.name);
    console.log(
  ...
  console.log(
    `\n  Summary: ${passedChecks}/${total} passed` +
      (failedBlocking > 0 ? `, \x1b[31m${failedBlocking} blocking failure(s)\x1b[0m` : "") +
