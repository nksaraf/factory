    ...
    choices: [
      {
        value: "resource",
        label: "Resource",
        hint: "Infrastructure like PostgreSQL, Redis, Kafka",
      },
      {
        value: "component",
        label: "Component",
        hint: "Service, website, or library",
      },
    ],
  })
}
...
const ADD_COMPONENT_TYPES: {
  value: Exclude<InitType, "project">
  label: string
  hint: string
}[] = [
...
export async function promptComponentType(): Promise<
  Exclude<InitType, "project">
> {
