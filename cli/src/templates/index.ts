...
// Resource templates
export { generateResource, isResourceName, RESOURCE_CATALOG } from "./resource/index";
export type { ResourceName, ResourceCatalogType, ResourceEntry } from "./resource/index";
