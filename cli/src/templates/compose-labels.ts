...
export function componentLabels(opts: ComponentLabelOpts): Record<string, string> {
...
export function resourceLabels(opts: ResourceLabelOpts): Record<string, string> {
  const labels: Record<string, string> = {
...
export function labelsToYaml(labels: Record<string, string>, indent: number): string {
