...
export const INIT_TYPES: {
...
}[] = [
  {
    value: "project",
    label: "Project",
    description: "Full monorepo with apps, services, packages, and resources",
  },
...
export const FRAMEWORKS: FrameworkEntry[] = [
  // Services
  {
    ...
    type: "service",
    runtime: "node",
    description: "Elysia + Drizzle REST API",
    templateKey: "node-api",
  },
  {
    value: "spring-boot",
    label: "Spring Boot",
  ...
  // Websites
  {
    ...
    type: "website",
    runtime: "node",
    description: "React SPA with SSR",
    templateKey: "web-app",
  },
  // Libraries
  {
...
export function getRuntimesForType(
  type: Exclude<InitType, "project">
): Runtime[] {
  const runtimes = new Set(
    FRAMEWORKS.filter((f) => f.type === type).map((f) => f.runtime)
  )
  return [...runtimes]
}
...
export const STANDALONE_TYPES: {
  ...
  },
  {
    value: "node-api",
    label: "Node API",
    description: "Node.js REST/HTTP API service",
  },
  {
    value: "java-api",
    label: "Java API",
    description: "Java REST/HTTP API service",
  },
  {
    value: "python-api",
    label: "Python API",
    description: "Python REST/HTTP API service",
  },
  {
    value: "node-lib",
    label: "Node Library",
    description: "Shared Node.js/TypeScript library",
  },
  {
    value: "java-lib",
    label: "Java Library",
    description: "Shared Java library",
  },
  {
    value: "python-lib",
