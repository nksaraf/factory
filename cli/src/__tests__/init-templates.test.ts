...
describe("generateProject", () => {
  ...
  it("generates starter service files under services/", () => {
    const servicePaths = paths.filter((p) =>
      p.startsWith("services/test-proj-api/")
    )
...
describe("generateStandalone", () => {
  ...
  for (const type of allTypes) {
    it(`${type} generates non-empty file list`, () => {
      const files = generateStandalone(type, {
        name: "test",
        owner: "team",
        description: "",
      })
  ...
  it("java types use correct package path", () => {
    const files = generateStandalone("java-api", {
      name: "my-service",
      owner: "team",
      description: "",
    })
  ...
  it("python-lib uses underscore module name", () => {
    const files = generateStandalone("python-lib", {
      name: "my-utils",
      owner: "team",
      description: "",
    })
