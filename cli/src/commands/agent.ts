...
const SKILL_MUTATE_FLAGS = {
  global: {
    ...
    short: "g",
    description: "Install/remove globally (user-level) instead of project-level",
  },
  agent: {
    ...
    .command("add", (c) =>
      c
        ...
        .run(async ({ args, flags }) => {
          ...
          try {
            const { agentSkillAdd } = await import(
              "../handlers/agent-skill/add.js"
            );
            await agentSkillAdd({
    ...
    .command("remove", (c) =>
      c
        ...
        .run(async ({ args, flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillRemove } = await import(
              "../handlers/agent-skill/remove.js"
            );
    ...
    .command("list", (c) =>
      c
        ...
        .run(async ({ flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillList } = await import(
              "../handlers/agent-skill/list.js"
            );
    ...
    .command("find", (c) =>
      c
        ...
        .run(async ({ args, flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillFind } = await import(
              "../handlers/agent-skill/find.js"
            );
    ...
    .command("check", (c) =>
      c
        ...
        .run(async ({ flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillCheck } = await import(
              "../handlers/agent-skill/check.js"
            );
    ...
    .command("update", (c) =>
      c
        ...
        .run(async ({ flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillUpdate } = await import(
              "../handlers/agent-skill/update.js"
            );
    ...
    .command("init", (c) =>
      c
        ...
        .run(async ({ args, flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillInit } = await import(
              "../handlers/agent-skill/init.js"
            );
    ...
    .command("sync", (c) =>
      c
        ...
        .run(async ({ flags }) => {
          const f = toDxFlags(flags);
          try {
            const { agentSkillSync } = await import(
              "../handlers/agent-skill/sync.js"
            );
