  ...
  return (
    app
      ...
      .command("remove", (c) =>
        c
          .meta({
            description: "Permanently delete a package from the workspace",
          })
          .args([
            {
              name: "package",
      ...
      .command("branch", (c) =>
        c
          .meta({
            description:
              "List, switch, or create branches for a linked package",
          })
          .args([
            {
              name: "package",
      ...
      .command("contribute", (c) =>
        c
          .meta({
            description: "Contribute a local package to an external repo",
          })
          .args([
            {
              name: "localPath",
              ...
              required: true,
              description:
                "Local package (e.g., ui-next or packages/npm/ui-next)",
            },
            {
              name: "target",
              type: "string",
          ...
          .run(async ({ args, flags }) => {
            ...
            try {
              await ensurePkgEnv()
              const { pkgContribute } =
                await import("../handlers/pkg/contribute.js")
        ...
        c
          ...
          .run(async ({ args, flags }) => {
            ...
            try {
              await ensurePkgEnv()
              const { pkgVersions } =
                await import("../handlers/pkg/versions.js")
      ...
      .command("publish", (c) =>
        c
          ...
          .run(async ({ args, flags }) => {
            ...
            try {
              await ensurePkgEnv()
              const { pkgPublish } = await import("../handlers/pkg/publish.js")
      ...
      .command("install", (c) =>
        c
          ...
          .run(async ({ flags }) => {
            ...
            try {
              const { pkgInstall } =
                await import("../handlers/pkg/install-workspace.js")
      ...
      .command("run", (c) =>
        c
          ...
          .run(async ({ args, flags }) => {
            ...
            try {
              const { pkgRunScript } =
                await import("../handlers/pkg/run-script.js")
