...
export function useSites() {
  return usePoll(
    async () => {
      ...
      const res = await api.api.v1.factory.ops.sites.get()
      return unwrap(res)
    },
    [],
    { interval: 10000 }
...
export function useReleases() {
  return usePoll(
    async () => {
      const api = await getFactoryClient()
      const res = await api.api.v1.factory.ops.releases.get({ query: {} })
      return unwrap(res)
    },
    [],
    { interval: 15000 }
...
export function useBuildRuns() {
  return usePoll(
    async () => {
      const api = await getFactoryClient()
      const res = await api.api.v1.factory.build["pipeline-runs"].get({
        query: {},
      })
      return unwrap(res)
    },
...
export function useAlerts() {
  return usePoll(
    async () => {
      const api = await getFactoryClient()
      const res = await api.api.v1.factory.observability.alerts.get({
        query: {},
      })
      return unwrap(res)
    },
