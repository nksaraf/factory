...
CREATE TABLE "infra"."runtime" (
	...
	"generation" bigint DEFAULT 0 NOT NULL,
	"observed_generation" bigint DEFAULT 0 NOT NULL,
	CONSTRAINT "infra_runtime_type_valid" CHECK ("infra"."runtime"."type" IN ('k8s-cluster', 'k8s-namespace', 'docker-engine', 'compose-project', 'systemd', 'reverse-proxy'))
);
--> statement-breakpoint
...
CREATE TABLE "org"."job" (
	...
	CONSTRAINT "org_job_trigger_valid" CHECK ("org"."job"."trigger" IN ('mention', 'event', 'schedule', 'delegation', 'manual'))
);
--> statement-breakpoint
...
CREATE TABLE "software"."entity_relationship" (
	...
	"spec" jsonb DEFAULT '{}' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "software_entity_rel_type_valid" CHECK ("software"."entity_relationship"."type" IN ('consumes-api', 'depends-on', 'provides', 'owned-by', 'deployed-alongside', 'triggers'))
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "work_tracker_provider_slug_unique" ON "factory_product"."work_tracker_provider" USING btree ("slug");--> statement-breakpoint
...
CREATE UNIQUE INDEX "software_entity_rel_unique" ON "software"."entity_relationship" USING btree ("type","source_kind","source_id","target_kind","target_id");--> statement-breakpoint
CREATE INDEX "software_entity_rel_type_idx" ON "software"."entity_relationship" USING btree ("type");--> statement-breakpoint
CREATE INDEX "software_entity_rel_source_idx" ON "software"."entity_relationship" USING btree ("source_kind","source_id");--> statement-breakpoint
CREATE INDEX "software_entity_rel_target_idx" ON "software"."entity_relationship" USING btree ("target_kind","target_id");--> statement-breakpoint
