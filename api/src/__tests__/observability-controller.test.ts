...
function createTestApp() {
  ...
  return new Elysia({ prefix: "/api/v1/factory" }).use(
...
describe("observabilityController", () => {
  ...
  it("GET /api/v1/factory/observability/logs returns empty result", async () => {
    const res = await app.handle(
      new Request("http://localhost/api/v1/factory/observability/logs")
    )
  ...
  it("GET /api/v1/factory/observability/logs with query params", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/logs?system=core&level=error&limit=10"
      )
    )
    expect(res.status).toBe(200)
    const body = await res.json()
  ...
  it("GET /api/v1/factory/observability/traces returns empty array", async () => {
    const res = await app.handle(
      new Request("http://localhost/api/v1/factory/observability/traces")
    )
    expect(res.status).toBe(200)
  ...
  it("GET /api/v1/factory/observability/traces/find returns empty array", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/traces/find?requestId=req-123"
      )
    )
    expect(res.status).toBe(200)
    expect(await res.json()).toEqual([])
  ...
  it("GET /api/v1/factory/observability/metrics/summary returns empty array", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/metrics/summary"
      )
    )
    expect(res.status).toBe(200)
    expect(await res.json()).toEqual([])
  ...
  it("GET /api/v1/factory/observability/metrics/:module/:component returns empty object", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/metrics/core/api"
      )
    )
    expect(res.status).toBe(200)
    expect(await res.json()).toEqual({})
  ...
  it("GET /api/v1/factory/observability/metrics/series returns empty array", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/metrics/series"
      )
    )
    expect(res.status).toBe(200)
    expect(await res.json()).toEqual([])
  ...
  it("POST /api/v1/factory/observability/metrics/query returns empty array", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/metrics/query",
        {
          method: "POST",
  ...
  it("POST /api/v1/factory/observability/alerts/:id/ack resolves", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/alerts/a1/ack",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  it("POST /api/v1/factory/observability/alerts/silence returns silenceId", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/alerts/silence",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  it("POST /api/v1/factory/observability/alerts/rules creates rule", async () => {
    const res = await app.handle(
      new Request(
        "http://localhost/api/v1/factory/observability/alerts/rules",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
