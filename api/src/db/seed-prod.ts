  ...
  await db.insert(team).values([
    {
      ...
      slug: "lepton",
      type: "business-unit",
      spec: { description: "Lepton Technologies" },
    },
    {
      id: engTeamId,
      name: "Engineering",
      ...
      spec: { description: "All product engineering teams" },
    },
    {
      id: platformTeamId,
      name: "Platform",
      ...
      type: "product-area",
      parentTeamId: rootTeamId,
      spec: { description: "Infrastructure and developer experience" },
    },
    {
      id: productTeamId,
      name: "Product",
      ...
      type: "product-area",
      parentTeamId: rootTeamId,
      spec: { description: "Product management" },
    },
    {
      id: qaTeamId,
      name: "QA",
      ...
      type: "team",
      parentTeamId: rootTeamId,
      spec: { description: "Quality assurance" },
    },
  ])
...
async function seedInfra() {
  ...
  const cloudAccountId = id("est", "lepton-proxmox", "est")
  const gcpAccountId = id("est", "google-gcp", "est")
  const datacenterId = id("est", "lepton-dc", "est")
  const hypervisorId = id("est", "pve-cluster-01", "est")
  const mgmtSubnetId = id("est", "mgmt-subnet", "est")
  const vmSubnetId = id("est", "vm-subnet", "est")
  ...
  await db.insert(estate).values([
    ...
    {
      id: datacenterId,
      slug: "lepton-datacenter",
      name: "Lepton Datacenter",
      type: "datacenter",
      parentEstateId: cloudAccountId,
      spec: {
        location: "Gurgaon, IN",
        lifecycle: "active",
        syncStatus: "idle",
    ...
    // Hypervisor (Proxmox cluster) — contains connection credentials
    {
      id: hypervisorId,
      slug: "pve-cluster-01",
      name: "Lepton PVE Cluster",
      type: "hypervisor",
      parentEstateId: datacenterId,
      spec: {
        providerKind: "proxmox",
        apiHost: "192.168.1.1",
        apiPort: 8006,
    ...
    // Subnets
    {
      ...
      spec: {
        ...
        metadata: {
          ...
          description: "Management / Proxmox node network",
        },
      },
    },
    {
  ...
  const vms = [
    {
      key: "app-smart-signal-fwa-stg",
      name: "app-smart-signal-fwa-stg",
      vmid: 100,
      ip: "192.168.2.79",
      status: "running",
      cpu: 4,
    ...
    {
      key: "docker-offline-install",
      name: "docker-offline-install",
      vmid: 102,
      ip: null,
      status: "stopped",
      cpu: 8,
    ...
    {
      key: "windows-samsung-sds",
      name: "windows-samsung-sds",
      vmid: 104,
      ip: "192.168.2.90",
      status: "running",
      cpu: 4,
    ...
    {
      key: "dev-lepton-admin",
      name: "dev-vikrant-trafficure",
      vmid: 105,
      ip: "192.168.2.26",
      status: "running",
      cpu: 8,
    ...
    {
      key: "app-trafficure-staging",
      name: "app-trafficure-staging",
      vmid: 106,
      ip: "192.168.2.97",
      status: "running",
      cpu: 16,
    ...
    {
      key: "bharatnet-mohali-vpn-jumpserver",
      name: "Bharatnet-Mohali-vpn-jumpserver",
      vmid: 111,
      ip: "192.168.2.47",
      status: "stopped",
      cpu: 3,
    ...
    {
      key: "sonu-postgres-offline",
      name: "sonu-postgres-offline",
      vmid: 112,
      ip: null,
      status: "stopped",
      cpu: 4,
    ...
    {
      key: "postgres-offline",
      name: "postgres-offline",
      vmid: 113,
      ip: null,
      status: "stopped",
      cpu: 8,
    ...
    {
      key: "service-graphhopper-australia-prod",
      name: "service-graphhopper-australia-prod",
      vmid: 114,
      ip: "192.168.2.81",
      status: "running",
      cpu: 16,
    ...
    {
      key: "dev-lepton-smartmarket",
      name: "Road-Selectio-Tool-Prod",
      vmid: 116,
      ip: "192.168.2.74",
      status: "running",
      cpu: 8,
    ...
    {
      key: "dev-ritvik-trafficure",
      name: "dev-ritvik-trafficure",
      vmid: 117,
      ip: "192.168.2.85",
      status: "running",
      cpu: 8,
    ...
    {
      key: "uat-lepton-smartmarket",
      name: "uat-lepton-smartmarket",
      vmid: 118,
      ip: null,
      status: "stopped",
      cpu: 4,
    ...
    {
      key: "vpn-ather-sm-windows",
      name: "vpn-ather-sm-windows",
      vmid: 121,
      ip: "192.168.2.78",
      status: "running",
      cpu: 16,
    ...
    {
      key: "service-planet-windows-trial",
      name: "service-planet-windows-trial",
      vmid: 122,
      ip: "192.168.2.70",
      status: "running",
      cpu: 12,
    ...
    {
      key: "service-smart-tender-prod",
      name: "service-smart-tender-prod",
      vmid: 123,
      ip: "192.168.2.71",
      status: "running",
      cpu: 8,
    ...
    {
      key: "app-trafficure-prod",
      name: "app-trafficure-prod",
      vmid: 124,
      ip: "192.168.2.86",
      status: "running",
      cpu: 8,
    ...
    {
      key: "vm-criticalreplicadbserver",
      name: "VM-CriticalReplicadbserver",
      vmid: 126,
      ip: null,
      status: "running",
      cpu: 20,
    ...
    {
      key: "trafficure-stress-test",
      name: "trafficure-stress-test",
      vmid: 129,
      ip: "192.168.2.95",
      status: "running",
      cpu: 8,
    ...
    {
      key: "service-zero-sync",
      name: "service-zero-sync",
      vmid: 130,
      ip: "192.168.2.87",
      status: "running",
      cpu: 4,
    ...
    {
      key: "service-zero-smart-tender",
      name: "service-zero-smart-tender",
      vmid: 131,
      ip: null,
      status: "stopped",
      cpu: 4,
    ...
    {
      key: "app-smart-signal-sc2-stg",
      name: "app-smart-signal-sc2-stg",
      vmid: 133,
      ip: "192.168.2.83",
      status: "running",
      cpu: 4,
    ...
    {
      key: "app-smart-market-2-stg",
      name: "app-smart-market-2-stg",
      vmid: 135,
      ip: "192.168.2.76",
      status: "running",
      cpu: 4,
    ...
    {
      key: "dev-vishwa-trafficure",
      name: "dev-vishwa-trafficure",
      vmid: 144,
      ip: "192.168.2.98",
      status: "running",
      cpu: 8,
    ...
    {
      key: "utc-app-trafficure",
      name: "app-trafficure-dev-server",
      vmid: 147,
      ip: "192.168.2.51",
      status: "running",
      cpu: 16,
    ...
    {
      key: "clickstack-lepton-api-149",
      name: "clickstack-lepton-api-old",
      vmid: 149,
      ip: null,
      status: "stopped",
      cpu: 12,
    ...
    {
      key: "clickstack-lepton-api",
      name: "clickstack-lepton-api",
      vmid: 150,
      ip: null,
      status: "running",
      cpu: 4,
  ...
  await db.insert(host).values(
    vms.map((v) => ({
      ...
      spec: {
        ...
        accessMethod: ((v as any).os === "windows" ? "rdp" : "ssh") as
          | "ssh"
          | "rdp",
        ...
        lifecycle: (v.status === "running" ? "active" : "offline") as
          | "active"
          | "offline",
      },
    }))
...
async function main() {
  ...
  await seedInfra()
  console.log("  [2/3] Infra seeded (estates, hosts, IPs)")
