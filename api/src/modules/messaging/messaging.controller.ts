    ...
    new Elysia({ prefix: "/messaging" })
      ...
      .post(
        ...
        }),
        {
          ...
          detail: {
            tags: ["Messaging"],
            summary: "Register messaging provider",
          },
        }
      )
      .get(
      ...
      .post(
        "/providers/:id/channels/:mapId/delete",
        async ({ params }) => {
      ...
      .post(
        ...
        },
        {
          ...
          detail: {
            tags: ["Messaging"],
            summary: "Link messaging user to principal",
          },
        }
      )
      .post(
        "/providers/:id/users/link/:linkId/delete",
        async ({ params }) => {
          const provider = await svc.getMessagingProvider(db, params.id)
          if (!provider) return { success: false, error: "provider_not_found" }
