    ...
    new Elysia()
      ...
      .post(
        ...
        async ({ body, set }) => {
          ...
          if (!slug && !scopeType) {
            ...
            return {
              success: false,
              error: "Must provide slug or scopeType to scope the rotation",
            }
          }
        ...
        },
        {
          ...
          detail: {
            tags: ["Secrets"],
            summary:
              "Re-encrypt secrets with the current (or specified) key version",
          },
        }
      )
      ...
      .post(
        ...
        },
        {
          ...
          detail: {
            tags: ["Secrets"],
            summary: "Resolve all secrets for a context",
          },
        }
      )
  )
