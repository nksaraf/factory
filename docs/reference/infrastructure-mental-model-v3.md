...
**Operational (how it's connected and deployed):**
13. Deployment
14. Workload
15. Managed Dependency
16. Data Store
17. Secret
...
*(Unchanged from V2, repeated for completeness)*
...
- "Dev environment" — is it the development *environment* (lifecycle stage) or the
  developer's *workspace* (compute environment)? Now you say: "a developer-workspace in
...
*(Enhanced from V2 with software catalog linkage)*
...
*(Updated to include sidecar and workspace-hosted patterns)*
...
*Version 3.0 — Synthesized from Backstage (Spotify), OpsLevel, Cortex, Port, Gitpod/Ona,
...
Palantir, Accenture, TCS, IBM/Kyndryl, Capgemini, and Cognizant.*
