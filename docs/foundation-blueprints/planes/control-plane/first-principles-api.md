...
| Recovery         | Reset Credential Flow        | POST /dbconnections/change_password  | POST /api/v1/authn/recovery     | Password Reset                  | `POST /self-service/recovery/flows`     | `POST /forget-password`   |
