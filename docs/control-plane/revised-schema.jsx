...
definition role {
  ...
  relation member: principal
    ...
    notes: "No changes from before. Principal, organization, and role remain stable.",
  },
  {
    id: "scope",
    label: "Scope Nodes",
...
const SEED_TYPES = [
  {
    ...
    actions: [
      ...
      { name: "view",     slot: 2, cascade: true,  implies: ["discover"],             requires: [] },
      { name: "edit",     slot: 3, cascade: true,  implies: ["view"],                 requires: [] },
      { name: "share",    slot: 4, cascade: false, implies: ["view"],                 requires: [] },
      { name: "admin",    slot: 5, cascade: false, implies: ["edit", "share"],         requires: [] },
    ],
    scopes: [],
  },
  {
    ...
    actions: [
      ...
      { name: "view",      slot: 2, cascade: true,  implies: ["discover"],                           requires: [] },
      { name: "edit",      slot: 3, cascade: true,  implies: ["view"],                               requires: [] },
      { name: "configure", slot: 4, cascade: false, implies: ["view"],                               requires: [] },
      { name: "deploy",    slot: 5, cascade: false, implies: ["view"],                               requires: [] },
      { name: "admin",     slot: 6, cascade: false, implies: ["edit", "configure", "deploy", "share"], requires: [] },
      { name: "share",     slot: 7, cascade: false, implies: ["view"],                               requires: [] },
    ],
    scopes: [
      { type: "region", required: false, mapping: { view: "view", edit: "manage", admin: "manage" } },
    ],
  },
  {
    id: "traffic_plan",
    ...
    actions: [
      ...
      { name: "edit",     slot: 2, cascade: false, implies: ["view"],           requires: [] },
      { name: "simulate", slot: 3, cascade: false, implies: ["view"],           requires: [] },
      { name: "approve",  slot: 4, cascade: false, implies: ["view"],           requires: [] },
      { name: "publish",  slot: 5, cascade: false, implies: [],                 requires: ["edit", "approve"] },
      { name: "admin",    slot: 6, cascade: false, implies: ["edit", "simulate", "approve", "publish"], requires: [] },
    ],
    scopes: [
      { type: "region", required: true, mapping: { view: "view", edit: "manage", simulate: "view", approve: "manage", publish: "manage" } },
      { type: "department", required: false, mapping: { edit: "participate", approve: "lead" } },
    ],
  },
  {
    id: "reg_document",
    ...
    actions: [
      { name: "discover", slot: 1, cascade: true,  implies: [],                             requires: [] },
      { name: "view",     slot: 2, cascade: true,  implies: ["discover"],                    requires: [] },
      { name: "comment",  slot: 3, cascade: false, implies: ["view"],                        requires: [] },
      { name: "edit",     slot: 4, cascade: false, implies: ["view"],                        requires: [] },
      { name: "review",   slot: 5, cascade: false, implies: ["view", "comment"],              requires: [] },
      { name: "approve",  slot: 6, cascade: false, implies: ["view"],                        requires: ["review"] },
      { name: "publish",  slot: 7, cascade: false, implies: [],                              requires: ["approve", "edit"] },
      { name: "admin",    slot: 8, cascade: false, implies: ["edit","review","approve","publish","comment"], requires: [] },
    ],
    scopes: [
      { type: "region", required: true, mapping: { view: "view", edit: "manage", approve: "manage", publish: "manage" } },
    ],
  },
];
...
const SCENARIOS = [
  {
    ...
    action: "edit",
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'project1 → resource_type = "project"', pass: null },
      { phase: "registry", label: "Lookup action", detail: "project.edit → slot: 3, cascade_from_parent: true, implies: [view], requires: []", pass: null },
      { phase: "spicedb",  label: "Choose SpiceDB perm", detail: "cascade=true → has_slot_3_cascade", pass: null },
      { phase: "spicedb",  label: "Check resource", detail: "resource:project1#has_slot_3_cascade@principal:sonu", pass: null },
      { phase: "spicedb",  label: "Direct slot_3?", detail: "resource:project1#slot_3@principal:sonu → ✗ NO", pass: false },
      { phase: "spicedb",  label: "Parent cascade", detail: "project1.parent = folder1 → resource:folder1#has_slot_3_cascade@principal:sonu", pass: null },
      { phase: "spicedb",  label: "folder1 direct", detail: "resource:folder1#slot_3@principal:sonu → ✓ HAS", pass: true },
      { phase: "spicedb",  label: "Org check", detail: "organization:lepton#guest@principal:sonu → ✓ PASS", pass: true },
      { phase: "scope",    label: "Scope required?", detail: "project.edit has scope binding: region → manage required", pass: null },
      { phase: "scope",    label: "Resource scope", detail: "project1#scope = scope_node:region_jharkhand", pass: null },
      { phase: "scope",    label: "Scope check", detail: "scope_node:region_jharkhand#has_slot_2@principal:sonu → ✗ NO (sonu has no region manage)", pass: false },
      { phase: "result",   label: "RESULT", detail: "✗ DENIED — sonu has edit via parent cascade but fails scope check (no 'manage' in jharkhand region)", pass: false },
    ],
  },
  {
    id: "cascade_no_scope",
    ...
    action: "edit",
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'folder1 → resource_type = "folder"', pass: null },
      { phase: "registry", label: "Lookup action", detail: "folder.edit → slot: 3, cascade_from_parent: true, implies: [view], requires: []", pass: null },
      { phase: "spicedb",  label: "Choose SpiceDB perm", detail: "cascade=true → has_slot_3_cascade", pass: null },
      { phase: "spicedb",  label: "Check resource", detail: "resource:folder1#has_slot_3_cascade@principal:sonu", pass: null },
      { phase: "spicedb",  label: "Direct slot_3?", detail: "resource:folder1#slot_3@principal:sonu → ✓ HAS", pass: true },
      { phase: "spicedb",  label: "Org check", detail: "organization:lepton#guest@principal:sonu → ✓ PASS", pass: true },
      { phase: "scope",    label: "Scope required?", detail: "folder type has NO scope bindings → skip scope check", pass: true },
      { phase: "result",   label: "RESULT", detail: "✓ ALLOWED — direct grant, no scope required for folders", pass: true },
    ],
  },
  {
    id: "non_cascade",
    ...
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'project1 → resource_type = "project"', pass: null },
      { phase: "registry", label: "Lookup action", detail: "project.configure → slot: 4, cascade_from_parent: false, implies: [view], requires: []", pass: null },
      { phase: "spicedb",  label: "Choose SpiceDB perm", detail: "cascade=false → has_slot_4_local", pass: null },
      { phase: "spicedb",  label: "Check resource", detail: "resource:project1#has_slot_4_local@principal:sonu", pass: null },
      { phase: "spicedb",  label: "Direct slot_4?", detail: "resource:project1#slot_4@principal:sonu → ✗ NO", pass: false },
      { phase: "implies",  label: "Parent cascade?", detail: "cascade_from_parent=false → NOT checked. Folder1's grants do NOT propagate.", pass: null },
      { phase: "implies",  label: "Implied by higher?", detail: "Which actions imply configure? → admin (slot_6)", pass: null },
      { phase: "spicedb",  label: "Check admin", detail: "resource:project1#has_slot_6_local@principal:sonu → ✗ NO", pass: false },
      { phase: "result",   label: "RESULT", detail: "✗ DENIED — configure is non-cascading, sonu has no direct configure or admin on project1", pass: false },
    ],
  },
  {
    id: "dag_not_chain",
    title: "DAG Permissions (configure ≠ deploy, both independent)",
    question: 'Can vikrant "deploy" project1? (has edit + deploy, not configure)',
    type: "project",
    principal: "vikrant",
    action: "deploy",
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'project1 → resource_type = "project"', pass: null },
      { phase: "registry", label: "Lookup action", detail: "project.deploy → slot: 5, cascade_from_parent: false, implies: [view], requires: []", pass: null },
      { phase: "spicedb",  label: "Choose SpiceDB perm", detail: "cascade=false → has_slot_5_local", pass: null },
      { phase: "spicedb",  label: "Check resource", detail: "resource:project1#has_slot_5_local@principal:vikrant", pass: null },
      { phase: "spicedb",  label: "Direct slot_5?", detail: "resource:project1#slot_5@principal:vikrant → ✓ HAS", pass: true },
      { phase: "spicedb",  label: "Org check", detail: "organization:lepton#member@principal:vikrant → ✓ PASS", pass: true },
      { phase: "scope",    label: "Scope check (region)", detail: "project.deploy has no scope mapping → skip", pass: true },
      { phase: "result",   label: "RESULT", detail: "✓ ALLOWED — vikrant has deploy directly. Note: vikrant does NOT have configure (slot_4). deploy and configure are independent branches in the DAG.", pass: true },
    ],
  },
  {
    id: "requires",
    ...
    action: "publish",
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'tp_001 → resource_type = "traffic_plan" (org: samsung)', pass: null },
      { phase: "registry", label: "Lookup action", detail: "traffic_plan.publish → slot: 5, cascade: false, implies: [], requires: [edit, approve]", pass: null },
      { phase: "requires", label: "REQUIRES check", detail: "publish has requires: [edit, approve] → must check BOTH independently", pass: null },
      { phase: "spicedb",  label: "Check 'edit'", detail: "traffic_plan.edit → slot_2, local → resource:tp_001#has_slot_2_local@principal:sonu", pass: null },
      { phase: "spicedb",  label: "Direct slot_2?", detail: "resource:tp_001#slot_2@principal:sonu → ✓ HAS", pass: true },
      { phase: "spicedb",  label: "Check 'approve'", detail: "traffic_plan.approve → slot_4, local → resource:tp_001#has_slot_4_local@principal:sonu", pass: null },
      { phase: "spicedb",  label: "Direct slot_4?", detail: "resource:tp_001#slot_4@principal:sonu → ✗ NO", pass: false },
      { phase: "implies",  label: "Implied by admin?", detail: "admin (slot_6) implies approve → resource:tp_001#has_slot_6_local@principal:sonu → ✗ NO", pass: false },
      { phase: "result",   label: "RESULT", detail: "✗ DENIED — sonu has edit but NOT approve. Publish REQUIRES both. Even though sonu can simulate and edit, they can't publish without approval authority.", pass: false },
    ],
  },
  {
    id: "requires_pass",
    ...
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'tp_001 → resource_type = "traffic_plan" (org: samsung)', pass: null },
      { phase: "registry", label: "Lookup action", detail: "traffic_plan.publish → slot: 5, cascade: false, requires: [edit, approve]", pass: null },
      { phase: "requires", label: "REQUIRES check", detail: "Must pass BOTH edit AND approve", pass: null },
      { phase: "spicedb",  label: "Check 'edit'", detail: "slot_2, local → resource:tp_001#has_slot_2_local@principal:vinay → ✓ HAS", pass: true },
      { phase: "spicedb",  label: "Check 'approve'", detail: "slot_4, local → resource:tp_001#has_slot_4_local@principal:vinay → ✓ HAS", pass: true },
      { phase: "spicedb",  label: "Org check", detail: "organization:samsung#member@principal:vinay → ✓ PASS", pass: true },
      { phase: "scope",    label: "Region scope", detail: "tp_001#scope = region_seoul. publish→manage. scope_node:region_seoul → parent:region_korea", pass: null },
      { phase: "scope",    label: "Region check", detail: "scope_node:region_korea#has_slot_2@principal:vinay → ✓ (vinay has manage on all korea)", pass: true },
      { phase: "scope",    label: "Dept scope", detail: "tp_001#scope = dept_planning. publish→(not mapped for dept) → skip", pass: true },
      { phase: "result",   label: "RESULT", detail: "✓ ALLOWED — vinay has both edit AND approve, passes region scope check via korea parent cascade", pass: true },
    ],
  },
  {
    id: "scope_exclusion",
    ...
    action: "edit",
    steps: [
      { phase: "registry", label: "Setup", detail: "Assume project2 scoped to region_patna, nikhil has edit via lepton_admin role", pass: null },
      { phase: "spicedb",  label: "Resource check", detail: "nikhil has slot_3 via role:lepton_admin#member → ✓ HAS", pass: true },
      { phase: "scope",    label: "Region scope", detail: "project.edit → region.manage (slot_2) required", pass: null },
      { phase: "scope",    label: "Scope resolution", detail: "scope_node:region_patna → parent: region_bihar → parent: region_india", pass: null },
      { phase: "scope",    label: "India slot_2?", detail: "scope_node:region_india#slot_2@principal:nikhil → ✓ HAS (would cascade down)", pass: true },
      { phase: "scope",    label: "Bihar exclusion!", detail: "scope_node:region_bihar#excluded@principal:nikhil → ✓ EXCLUDED", pass: false },
      { phase: "scope",    label: "Exclusion propagates", detail: "Bihar exclusion blocks cascade to patna. nikhil's india grant doesn't reach patna.", pass: false },
      { phase: "result",   label: "RESULT", detail: "✗ DENIED — nikhil has manage for all india BUT is excluded from bihar subtree. Patna is under bihar, so scope check fails.", pass: false },
    ],
  },
  {
    id: "eight_slot",
    ...
    action: "approve",
    steps: [
      { phase: "registry", label: "Resolve type", detail: 'reg_document: 8 actions across 8 slots', pass: null },
      { phase: "registry", label: "Lookup action", detail: "reg_document.approve → slot: 6, cascade: false, implies: [view], requires: [review]", pass: null },
      { phase: "requires", label: "REQUIRES check", detail: "approve requires [review] → must independently check review first", pass: null },
      { phase: "spicedb",  label: "Check 'review'", detail: "slot_5, local → must have direct review grant", pass: null },
      { phase: "spicedb",  label: "Then check 'approve'", detail: "slot_6, local → must also have direct approve grant", pass: null },
      { phase: "registry", label: "Implication chain", detail: "review implies [view, comment] → if you can review, you can also view and comment automatically", pass: null },
      { phase: "registry", label: "Publish requires", detail: "publish (slot_7) requires [approve, edit] → separation of duties enforced by schema", pass: null },
      { phase: "result",   label: "Architecture note", detail: "8 slots used. discover→view→comment→edit→review→approve→publish→admin. Each with independent cascade and requires config. No chain assumption.", pass: null },
    ],
  },
];
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        }}>PLATFORM FABRIC — AUTHORIZATION v2</div>
        <div style={{ fontSize: "18px", fontWeight: 700, color: "#fafafa", letterSpacing: "-0.01em" }}>
      ...
      <div style={{
        ...
        {TABS.map(t => (
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            padding: "6px 12px", borderRadius: "3px", border: "none", cursor: "pointer",
      ...
      {tab === "schema" && (
        <div>
          <div style={{ display: "flex", gap: "1px", marginBottom: "12px", borderRadius: "4px", overflow: "hidden", border: "1px solid #18181b", backgroundColor: "#0d0d0f", padding: "2px" }}>
            {SCHEMA_SECTIONS.map(s => (
              <button key={s.id} onClick={() => setSchemaSection(s.id)} style={{
                padding: "5px 10px", borderRadius: "3px", border: "none", cursor: "pointer",
                fontSize: "10px", fontWeight: 600, fontFamily: mono,
                backgroundColor: schemaSection === s.id ? "#1c1c24" : "transparent",
                color: schemaSection === s.id ? "#fafafa" : "#52525b",
              }}>{s.label}</button>
            ))}
            <button onClick={() => setSchemaSection("full")} style={{
              padding: "5px 10px", borderRadius: "3px", border: "none", cursor: "pointer",
              fontSize: "10px", fontWeight: 600, fontFamily: mono, marginLeft: "auto",
              backgroundColor: schemaSection === "full" ? "#1c1c24" : "transparent",
          ...
          {schemaSection === "full" ? (
            ...
            const section = SCHEMA_SECTIONS.find(s => s.id === schemaSection);
            return (
              <div>
                <Code maxHeight="500px">{section.schema}</Code>
                <div style={{
                  marginTop: "10px", padding: "10px 14px", borderRadius: "5px",
      ...
      {tab === "registry" && (
        <div>
          <div style={{
            ...
            border: "1px solid #3b82f625", backgroundColor: "#080c14",
            fontSize: "11px", color: "#93c5fd", lineHeight: "1.7",
          }}>
            <strong>Key addition:</strong> <code style={{ fontFamily: mono }}>resource_type_scope_binding</code> table
            decouples scope slot numbering from resource slot numbering. Each resource type declares which scope
            dimensions it participates in and maps its actions to scope actions independently.
          </div>
      ...
      {tab === "tuples" && (
        <div>
          <div style={{
            ...
            Note how <code style={{ fontFamily: mono }}>slot_N</code> is used instead of semantic names.
            <code style={{ fontFamily: mono }}> resource:project1#slot_3</code> means "project.edit" because
            the registry maps project.edit → slot 3. Samsung's traffic_plan maps edit → slot 2 (different number, same semantics).
          </div>
          ...
          {currentScenario && (
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: "11px", fontWeight: 700, color: "#e4e4e7", marginBottom: "2px" }}>
                  {currentScenario.title}
                </div>
                <div style={{ fontSize: "13px", fontWeight: 700, color: "#fafafa", fontFamily: mono }}>
              ...
              {currentScenario.steps.map((step, i) => {
                ...
                return (
                  <div key={i} style={{
                    ...
                    borderBottom: i < currentScenario.steps.length - 1 ? "1px solid #111114" : "none",
                    backgroundColor: isResult
                      ? (step.pass ? "#0a160a" : "#160a0a")
                      : (i % 2 === 0 ? "transparent" : "#0a0a0e08"),
                  }}>
                    <span style={{
                      fontSize: "8px", fontWeight: 700, fontFamily: mono,
                      color: phaseColor, minWidth: "52px", paddingTop: "3px",
                      textTransform: "uppercase", letterSpacing: "0.05em",
                    }}>{step.phase}</span>
                    <span style={{
                      fontSize: "10px", fontWeight: 700, fontFamily: mono,
                      color: isResult ? (step.pass ? "#4ade80" : "#f87171") : "#a1a1aa",
                      minWidth: "130px", paddingTop: "1px",
                    }}>{step.label}</span>
                    <span style={{
                      fontSize: "10.5px", fontFamily: mono, lineHeight: "1.6",
                      color: isResult
                        ? (step.pass ? "#86efac" : "#fca5a5")
                        : step.pass === true ? "#a1a1aa"
                        : step.pass === false ? "#f8717199"
                        : "#71717a",
                    }}>{step.detail}</span>
                  </div>
                );
      ...
      {tab === "runtime" && (
        <div>
          <div style={{
            ...
            Two versions shown: sequential (readable) and bulk-optimized (production).
            The bulk version collects ALL possible checks upfront and fires one <code style={{ fontFamily: mono }}>BulkCheckPermission</code> RPC.
          </div>
          ...
          <div style={{
            ...
            {SEED_TYPES.map(t => (
              <button key={t.id} onClick={() => setSelectedType(t.id)} style={{
                ...
                fontSize: "10.5px", fontWeight: 600, fontFamily: sans,
                backgroundColor: selectedType === t.id ? "#1c1c24" : "#0d0d0f",
                color: selectedType === t.id ? "#fafafa" : "#52525b",
              }}>
                {t.label}
                <span style={{ marginLeft: "6px", fontSize: "9px", color: "#71717a" }}>{t.org}</span>
              </button>
            ))}
          </div>
          ...
          {currentType && (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
              ...
              <div style={{
                ...
                <div style={{
                  padding: "8px 14px", backgroundColor: "#0e0e12",
                  borderBottom: "1px solid #18181b",
                  ...
                  <Badge text={`${currentType.actions.length} slots used`} color="#4ade80" small />
                  {currentType.system && <Badge text="SYSTEM" color="#3b82f6" small />}
                  {!currentType.system && <Badge text="USER-DEFINED" color="#f59e0b" small />}
                </div>

                {currentType.actions.map((a, i) => (
                  <div key={i} style={{
                    padding: "6px 14px", borderBottom: i < currentType.actions.length - 1 ? "1px solid #111114" : "none",
                    fontSize: "10.5px", fontFamily: mono,
                  }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "2px" }}>
                      <span style={{ color: "#e4e4e7", fontWeight: 700, minWidth: "80px" }}>{a.name}</span>
                      <Badge text={`slot_${a.slot}`} color="#f59e0b" small />
                      <Badge text={a.cascade ? "cascade" : "local"} color={a.cascade ? "#4ade80" : "#f87171"} small />
                    </div>
                    {a.implies.length > 0 && (
                      <div style={{ color: "#818cf8", fontSize: "9.5px", paddingLeft: "4px" }}>
                        implies: [{a.implies.join(", ")}]
                      </div>
                    )}
                    {a.requires.length > 0 && (
                      <div style={{ color: "#fb923c", fontSize: "9.5px", paddingLeft: "4px", fontWeight: 700 }}>
              ...
              <div>
                ...
                <div style={{
                  ...
                  }}>Permission DAG (implies graph)</div>
                  <div style={{
                    padding: "12px 14px", fontFamily: mono, fontSize: "11px",
                    lineHeight: "1.8", color: "#71717a", whiteSpace: "pre",
                  }}>
                    {(() => {
                      ...
                      const allImplied = new Set(actions.flatMap(a => a.implies));
                      const allRequired = new Set(actions.flatMap(a => a.requires));
                      const roots = actions.filter(a => !allImplied.has(a.name));
                      const leaves = actions.filter(a => a.implies.length === 0 && a.requires.length === 0);
                      ...
                      for (const a of actions) {
                        ...
                        lines.push(`${marker} slot_${a.slot} ${a.name.padEnd(12)} [${cascadeTag}]${suffix}`);
                      }
                      lines.push("");
                ...
                <div style={{
                  ...
                  <div style={{ padding: "10px 14px" }}>
                    {currentType.scopes.length === 0 ? (
                      <div style={{ fontSize: "11px", color: "#52525b", fontFamily: mono }}>
                        No scope bindings — permissions checked without scope constraints
                      </div>
                    ) : (
                      currentType.scopes.map((s, i) => (
                        <div key={i} style={{
                          marginBottom: i < currentType.scopes.length - 1 ? "10px" : 0,
                        }}>
                          <div style={{
                            display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px",
                          }}>
                            <Badge text={s.type} color="#f59e0b" />
                            {s.required && <Badge text="REQUIRED" color="#f87171" small />}
                          </div>
                          <div style={{
                            fontFamily: mono, fontSize: "10px", color: "#71717a",
                            lineHeight: "1.8", paddingLeft: "8px",
                          }}>
                            {Object.entries(s.mapping).map(([ra, sa]) => (
                              <div key={ra}>
                                <span style={{ color: "#a1a1aa" }}>{ra}</span>
                                <span style={{ color: "#52525b" }}> → scope.</span>
