...
export const CapabilitySpecSchema = z.object({
  activation: z.enum(["flag", "config", "deploy", "independent"]).default("flag"),
...
export type EntityRelationshipSpec = z.infer<typeof EntityRelationshipSpecSchema>;
