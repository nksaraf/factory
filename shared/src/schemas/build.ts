...
export type GithubAppInstallationSpec = z.infer<
  typeof GithubAppInstallationSpecSchema
>
...
export type WorkTrackerProviderSpec = z.infer<
  typeof WorkTrackerProviderSpecSchema
>
...
export const WorkTrackerProjectSpecSchema = z.object({
  key: z.string(),
  url: z.string().optional(),
  description: z.string().optional(),
})
export type WorkTrackerProjectSpec = z.infer<
  typeof WorkTrackerProjectSpecSchema
>

export const WorkTrackerProjectSchema = z.object({
  id: z.string(),
  slug: z.string(),
  name: z.string(),
  workTrackerProviderId: z.string(),
  externalId: z.string(),
  spec: WorkTrackerProjectSpecSchema,
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
})
export type WorkTrackerProject = z.infer<typeof WorkTrackerProjectSchema>
...
export const UpdateWorkTrackerProviderSchema =
  CreateWorkTrackerProviderSchema.partial()

export const CreateWorkTrackerProjectSchema = z.object({
  slug: z.string().min(1).max(100),
  name: z.string().min(1).max(200),
  workTrackerProviderId: z.string(),
...
export const UpdateWorkTrackerProjectSchema =
  CreateWorkTrackerProjectSchema.partial()
